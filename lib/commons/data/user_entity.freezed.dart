...
abstract class $UserEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String? name, int? age, String? state, DateTime? date, String? gender});
}
...
class _$_UserEntity implements _UserEntity {
  const _$_UserEntity(
      {this.name, this.age, this.state, this.date, this.gender});
  ...
  @override
  String toString() {
    return 'UserEntity(name: $name, age: $age, state: $state, date: $date, gender: $gender)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, age, state, date, gender);
...
abstract class _UserEntity implements UserEntity {
  const factory _UserEntity(
      ...
      final String? state,
      final DateTime? date,
      final String? gender}) = _$_UserEntity;
